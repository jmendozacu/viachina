...
jQuery(document).ready(function() {
	...
	jQuery('#co-shipping-form').change(function(){
		shipping.supressErrors = 1;
		shipping.save();
	});
...
jQuery.extend(Shipping.prototype, {
	...
	save: function() {
		...
		this.xhr = jQuery.post(jQuery(this.options.form).attr('action'), jQuery(this.options.form).serialize(), this.nextStep, 'json');
	},
