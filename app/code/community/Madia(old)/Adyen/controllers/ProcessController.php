...
/** http://domaintje/adyen/process/ins
...
class Madia_Adyen_ProcessController extends Mage_Core_Controller_Front_Action {
    ...
    public function getOrderStatusAction()
    {
    	if($_POST['merchantReference'] != "") {
    		...
    		if($order->getStatus() == Mage_Sales_Model_Order::STATE_PROCESSING || $order->getAdyenEventCode() == Madia_Adyen_Model_Event::ADYEN_EVENT_POSAPPROVED) {
    			echo 'true';
    		}
    	}	
    	return;
