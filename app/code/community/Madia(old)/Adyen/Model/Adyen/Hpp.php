...
class Madia_Adyen_Model_Adyen_Hpp extends Madia_Adyen_Model_Adyen_Abstract {
    ...
    public function getFormFields() {
       ...
       // if (strpos($this->getInfoInstance()->getCcType(),"openinvoice") !== false || Mage::getStoreConfig("payment/adyen_hpp/disable_hpptypes")=="1") {
    ...
    public function _getBlockMethods() {
        ...
        $boleto = ($this->_getConfigData('active', 'adyen_boleto')) ? 'boleto' : false;
        
        if ($boleto !== false) {
        	$blockedMethods = array($boleto);
        }
        if ($elv !== false) {
