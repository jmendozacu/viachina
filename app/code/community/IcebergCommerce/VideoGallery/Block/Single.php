...
class IcebergCommerce_VideoGallery_Block_Single extends Mage_Core_Block_Template
{
	...
	public function getEmbedCode($width, $height=null)
	{
		return $this->getModel()->getEmbedCode($width, $height);
	}
	
	public function getMobileEmbedCode($width, $height=null)
	{
		return $this->getModel()->getMobileEmbedCode($width, $height);
	}
