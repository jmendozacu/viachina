	...
	extends Mage_Catalog_Block_Product_View_Media
{
    ...
    public function getMobileEmbed($video, $width, $height)
    {
    	...
    	return Mage::helper('videogallery/video')->getVideoByValue($video['value'],$video['provider'])->getMobileEmbedCode($width,$height);
    }
