...
<iframe frameborder="0" width="{$width}" height="{$height}" src="http://www.dailymotion.com/embed/video/{$this->video_value}?width=&theme=none&foreground=%23F7FFFD&highlight=%23FFC300&background=%23171D1B&additionalInfos=1&related=0&start=&animatedTitle=&iframe=0&hideInfos=0&wmode=transparent{$autoplayConfig}"></iframe>

<!--
<object width="100%" height="100%">
	<param name="movie" value="http://www.dailymotion.com/swf/video/{$this->video_value}?width=&theme=none&foreground=%23F7FFFD&highlight=%23FFC300&background=%23171D1B&additionalInfos=1&related=0&start=&animatedTitle=&iframe=0&hideInfos=0{$autoplayConfig}"></param>
	<param name="allowFullScreen" value="true"></param>
	<param name="allowScriptAccess" value="always"></param>
	<param name="wmode" value="transparent"></param>
	<embed type="application/x-shockwave-flash" src="http://www.dailymotion.com/swf/video/{$this->video_value}?width=&theme=none&foreground=%23F7FFFD&highlight=%23FFC300&background=%23171D1B&additionalInfos=1&related=0&start=&animatedTitle=&iframe=0&hideInfos=0{$autoplayConfig}" width="100%" height="100%" allowfullscreen="true" allowscriptaccess="always" wmode="transparent"></embed>
	</object>
	-->
</div>
END;
