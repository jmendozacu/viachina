...
<iframe src="http://player.vimeo.com/video/{$this->video_value}?&amp;show_title=1show_byline=0&amp;show_portrait=0&amp;fullscreen=1&amp;wmode=transparent$autoplayConfig" width="{$width}" height="{$height}" frameborder="0"></iframe>
<!--
	<object width="100%" height="100%"><param name="allowfullscreen" value="true" />
	    <param name="allowscriptaccess" value="always" />
	    <param name="wmode" value="transparent" />
	    <param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id=$videoId&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=0&amp;show_portrait=0&amp;fullscreen=1$autoplayConfig" />
	    <embed src="http://vimeo.com/moogaloop.swf?clip_id=$videoId&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=0&amp;show_portrait=0&amp;fullscreen=1$autoplayConfig" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="100%" height="100%" wmode="transparent"></embed>
	</object>
-->
</div>
END;
