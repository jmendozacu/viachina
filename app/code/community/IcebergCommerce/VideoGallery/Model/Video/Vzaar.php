...
<div class="video-object" style="width: {$width}px; height: {$height}px;">
	<object width="100%" height="100%" type="application/x-shockwave-flash" data="http://view.vzaar.com/{$videoId}.flashplayer">
		...
		<embed src="http://view.vzaar.com/{$videoId}.flashplayer" type="application/x-shockwave-flash" wmode="transparent" width="{$width}" height="{$height}" allowScriptAccess="always" allowFullScreen="true" flashvars="$autoplayConfig"></embed>
