...
END;
	...
	public function getMobileEmbedCode($width, $height, $autoplay=true)
	{
		return <<<END
<div class="video-object" style="width: {$width}px; height: {$height}px;">
	<video controls="controls" style="width:{$width}px;height:{$height}px; display: block; cursor: pointer; -webkit-user-drag: none; " src="{$this->getUrl($this->video_value)}"></video>
</div>
END;
	}
