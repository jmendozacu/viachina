...
class AW_Rma_Block_Adminhtml_Rma_Edit_Tab_Requestinformation extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $details->addField('rma_id', 'text', array(
            'name'  => 'rma_id',
            'label' => $this->__('ID')
        ));
        ...
        $requestoptions->addField('package_opened', 'select', array(
            'name'   => 'package_opened',
        ...
        if (Mage::helper('awrma/config')->getReasonsEnabled()) {
            $reasonDetails = $form->addFieldset('reason', array(
            ...
            $reasonDetails->addField('reason_id', 'select', array(
                'name'   => 'reason_id',
            ...
            if (Mage::helper('awrma/config')->getReasonsOtherOptionEnabled()) {
                $reasonDetails->addField('reason_details', 'textarea', array(
                    'name'  => 'reason_details',
