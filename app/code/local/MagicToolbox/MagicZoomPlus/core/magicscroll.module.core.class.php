...
if(!defined('MagicScrollModuleCoreClassLoaded')) {
    ...
    class MagicScrollModuleCoreClass {
        ...
        function getHeadersTemplate($jsPath = '', $cssPath = null) {
            ...
            $headers = array();
            // add module version
            $headers[] = '<!-- Magic Zoom Plus Magento module version v4.8.5 [v1.3.27:v4.5.18] -->';
            // add style link
