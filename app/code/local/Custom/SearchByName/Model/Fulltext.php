 ...
 */
class Custom_SearchByName_Model_Fulltext extends Mage_CatalogSearch_Model_Fulltext
{
    ...
    {
        $this->_init('searchbyname/fulltext');
    }
    ...
    {
        if (!$query instanceof Custom_SearchByName_Model_Query) {
            $query = Mage::helper('searchbyname')->getQuery();
        }
        $queryText = Mage::helper('searchbyname')->getQueryText();
        $queryAttributes = Mage::helper('searchbyname')->getQuery()->getAttribute();
        $this->getResource()->prepareResult($this, $queryAttributes, $query);
        return $this;
    }
