...
class MW_Dailydeal_Model_Dealschedulerproduct extends Mage_Core_Model_Abstract {
    ...
    /**
     * @return MW_Dailydeal_Model_Dealschedulerproduct
     */
     ...
     */
    public function sortProductOptionArray($data = array(), $generate_type = MW_Dailydeal_Model_Status::DEAL_SCHEDULER_GENERATE_TYPE_ROTATORS) {

        if ($generate_type == MW_Dailydeal_Model_Status::DEAL_SCHEDULER_GENERATE_TYPE_RANDOMLY) {
            shuffle($data);
        } elseif ($generate_type == MW_Dailydeal_Model_Status::DEAL_SCHEDULER_GENERATE_TYPE_ROTATORS) {
            MW_Dailydeal_Helper_Data::reIndexArray($data);
        }
        return $data;
    }
}