...
class MW_Dailydeal_Model_Observer
{
    ...
    public function catalog_product_get_final_price($observer)
    {
        ...
        $deal = MW_Dailydeal_Model_Dailydeal::getModel();
    ...
    public function salesorder_placeafter($observer)
    {
        ...
        foreach ($items as $item) {
            ...
            if ($productid) {
                $deal = MW_Dailydeal_Model_Dailydeal::getModel()->loadByProductId($productid);
                ...
                if ($deal->getId()) {
                    ...
                    MW_Dailydeal_Model_Product::getInstance()->disableProductByDealId(array($deal->getId()));

                    $info_buyRequest = MW_Dailydeal_Model_Order::getInstance()->markProductOfDeal($item, $deal);
    ...
    public function orderSaveAfter($observer)
    {
        ...
        $model_order = MW_Dailydeal_Model_Order::getInstance();
    ...
    {
        MW_Dailydeal_Model_Layout::overrideProductView($observer);
    }
