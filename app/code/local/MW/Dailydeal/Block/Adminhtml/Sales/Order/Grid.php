...
class MW_Dailydeal_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $deal_id = Mage::app()->getRequest()->getParam('id');
        $model_deal = MW_Dailydeal_Model_Dailydeal::getModel()->load($deal_id);
        
        $collection = Mage::getResourceModel($this->_getCollectionClass())
                ->addAttributeToFilter('entity_id', array('in' => $model_deal->getOrderId()));
