...
class MW_Dailydeal_Block_Adminhtml_Dealscheduler_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = MW_Dailydeal_Model_Dealscheduler::getInstance()->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('title', array(
            'header' => Mage::helper('dailydeal')->__('Deal Generator Title'),
            'align' => 'left',
            'width' => '200px',
            'index' => 'title',
        ));
        ...
        $this->addColumn('deal_time', array(
            'header' => Mage::helper('dailydeal')->__('Deal Duration Cycle (hours)'),
            'width' => '80px',
            'index' => 'deal_time',
            'type' => 'number',
        ));
        ...
        $this->addColumn('deal_price', array(
            'header' => Mage::helper('dailydeal')->__('Discount'),
            'align' => 'left',
            'index' => 'deal_price',
        ));
        
        $this->addColumn('deal_qty', array(
            'header' => Mage::helper('dailydeal')->__('Deal Quantity'),
            'index' => 'deal_qty',
        ));
...
//        ));
        ...
        $this->addColumn('number_deal', array(
            'header' => Mage::helper('dailydeal')->__('# of Daily Deals Generated'),
            'width' => '80px',
            'align' => 'left',
            'index' => 'number_deal',
            'type' => 'number',
        ...
        $this->addColumn('start_date_time', array(
            'header' => Mage::helper('dailydeal')->__('From Date'),
            'width' => '130px',
            'align' => 'left',
        ...
        $this->addColumn('end_date_time', array(
            'header' => Mage::helper('dailydeal')->__('To Date'),
            'width' => '130px',
            'align' => 'left',
            'index' => 'end_date_time',
            'type'=>'datetime',
        ...
        $this->addColumn('status', array(
            ...
            'index' => 'status',
            'type' => 'options',
            'options' => MW_Dailydeal_Model_Status::getOptionArray(),
        ));
