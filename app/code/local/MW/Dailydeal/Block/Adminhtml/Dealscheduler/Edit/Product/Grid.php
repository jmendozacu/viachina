...
class MW_Dailydeal_Block_adminhtml_Dealscheduler_Edit_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _toHtml(){
        if($this->getData('comment_deal') == 1){
            $html = Mage::helper('dailydeal')->__('<p class="note"><span class="required">*</span> You can override defaults set in Deal Generator Settings. Leave blank to use default values.</p>');
            $html .= Mage::helper('dailydeal')->__('<p class="note"><span class="required">**</span> Set Position for sequentially generated deals</p>');
        }
