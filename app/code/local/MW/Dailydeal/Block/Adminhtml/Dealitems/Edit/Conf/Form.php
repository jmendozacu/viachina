...
class MW_Dailydeal_Block_Adminhtml_Dealitems_Edit_Conf_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $block = $layout->createBlock('dailydeal/deal')
                ->setTemplate('mw_dailydeal/dealitems/javascript_form_deal.phtml');
        ...
        $fieldset->addField('product_price', 'text', array(
            'name' => 'product_price',
            'label' => Mage::helper('dailydeal')->__('Product Price') . ' ' . MW_Dailydeal_Helper_Data::GetCurrencyCodeHtml(),
            'readonly' => true,
            'class' => 'textbox-readonly',
        ));
        ...
        $fieldset->addField('disable_product_after_finish', 'select', array(
            ...
            'values' => MW_Dailydeal_Model_Status::getProductOptionArray(),
        ...
        $fieldset->addField('featured', 'select', array(
            ...
            'values' => MW_Dailydeal_Model_Status::getFeaturedOptionArray(),
    ...
    protected function setAddFormDefaultValue()
    {
        ...
        $data['status'] = empty($data['status']) ? MW_Dailydeal_Model_Status::STATUS_ENABLED : $data['status'];
        $data['featured'] = empty($data['featured']) ? MW_Dailydeal_Model_Status::STATUS_FEATURED_DISABLED : $data['featured'];
        $data['disable_product_after_finish'] = empty($data['disable_product_after_finish']) ? MW_Dailydeal_Model_Status::STATUS_PRODUCT_DISABLED : $data['disable_product_after_finish'];
