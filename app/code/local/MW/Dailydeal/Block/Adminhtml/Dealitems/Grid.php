...
class MW_Dailydeal_Block_Adminhtml_Dealitems_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        MW_Dailydeal_Model_Business::autoUpdateDealActive();
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('product_price', array(
            'header' => Mage::helper('dailydeal')->__('Regular Price'),
            'type' => 'price',
            'align' => 'left',
        ...
        $this->addColumn('featured', array(
            ...
            'index' => 'featured',
            'type' => 'options',
            'options' => MW_Dailydeal_Model_Status::getFeaturedOptionArray(),
            'filter_index'=>'main_table.featured'
        ));
        $this->addColumn('title', array(
            'header' => Mage::helper('dailydeal')->__('Generated Deal'),
            'align' => 'left',
            'width' => '70px',
            'index' => 'title',
        ...
        $this->addColumn('active', array(
            ...
            'index' => 'active',
            'type' => 'options',
            'options' => MW_Dailydeal_Model_Status::getStatusTimeOptionArray(),
            'renderer' => new MW_Dailydeal_Block_Adminhtml_Renderer_Active(),
