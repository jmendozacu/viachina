...
class MW_Dailydeal_Block_Adminhtml_Dealitems_Edit_Report_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $block = $this->getLayout()->createBlock(new MW_Dailydeal_Block_Adminhtml_Sales_Order_Grid());
