<?php
class MW_Dailydeal_Block_Sidebar_Left extends Mage_Core_Block_Template
{
	public function _prepareLayout()
    {
    	...
    	if ($dailydeal == 1 || $activedeal == 1 || $calendar == 1) 
    		$this->setTemplate('mw_dailydeal/sidebar/left_staticsidebar.phtml');
