...
class MW_Dailydeal_Block_Showtabs_Past extends Mage_Catalog_Block_Product_List
{
        ...
        if (is_null($this->_productCollection)) {
            ...
            $collection = Mage::getModel('dailydeal/dailydeal')->getCollection()
                ...
                ->addFieldToFilter(array('end_date_time', 'expire'),array(
                    ...
                    array('expire' => MW_Dailydeal_Model_Status::STATUS_EXPIRE_TRUE)
                ));
                */
                $collection->getSelect()->where("
                    (end_date_time <= '{$currenttime}') OR (((expire = '". MW_Dailydeal_Model_Status::STATUS_EXPIRE_TRUE . "')))
                ");
