...
class MW_Dailydeal_Helper_Data extends Mage_Core_Helper_Abstract
{
    /*
     * date formats
     */
    ...
    {
        $enc_key = MW_Dailydeal_Helper_Data::GetEncriptionKey();
...
//]]>
    ...
    public static function categoryDealInfo($product)
    {
        ...
        $block = $layout->createBlock('dailydeal/deal')
                ...
                ->setTemplate('mw_dailydeal/catalog/product/countdown.phtml');
    ...
    public static function productDealInfo($product)
    {
        ...
        $block = $layout->createBlock('dailydeal/deal')
                ->setData('product', $product)
                ->setTemplate('mw_dailydeal/catalog/product/view_countdown.phtml');
        return $block->renderView();
    }
    ...
    public static function showImage($product)
    {
        ...
        $block = $layout->createBlock('dailydeal/deal')
                ->setData('product', $product)
                ->setTemplate('mw_dailydeal/catalog/product/show_image.phtml');
        return $block->renderView();
    }
    ...
    public static function getUrlImageCatalogList($store_id = "")
    {
        if(self::getConfigLabelImage() == ''){
            $url = Mage::getBaseUrl('media'). 'mw_dailydeal/' . 'images/sale.png';
        }else{
            $url = Mage::getBaseUrl('media'). 'mw_dailydeal/' . self::getConfigLabelImage($store_id);
        }
...
MW_Dailydeal_Helper_Data::StaticConstructor();
